...
//                new LayerParameters().setNumRBMS(1).setVisibleUnitsPerRBM(20).setHiddenUnitsPerRBM(100),    // 20 in, 100 out
        ...
        final MNISTImageLoader mnistImageLoader = new MNISTImageLoader();
        final Matrix trainingData = mnistImageLoader.loadIdx3("/kenny/ml/nn/rbm/train-images-idx3-ubyte").divide(255.0);  // 60,000 inputs
        final Matrix testData = mnistImageLoader.loadIdx3("/kenny/ml/nn/rbm/t10k-images-idx3-ubyte").divide(255.0);  // 10,000 inputs
    ...
    public void imageLarge24BitDeepRBM() {
        ...
        final Image jetImage = new Image("/kenny/ml/nn/rbm/fighter_jet.jpg");
        final Matrix jetMatrix = new Matrix24BitImageEncoder().encode(jetImage);

...
public class SelfOrganizingMapRGBViewerWeightVector6D extends Canvas {
	...
	public static void main(String argv[]) {
		SelfOrganizingMapRGBViewerWeightVector6D somv =new SelfOrganizingMapRGBViewerWeightVector6D();
	...
	public SelfOrganizingMapRGBViewerWeightVector6D() {
		// create a frame 

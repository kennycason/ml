...
public class Polynomial2DViewer extends Canvas {
	...
	public static void main(String argv[]) throws IOException {
		Polynomial2DViewer somv = new Polynomial2DViewer();
	...
	public void init() throws IOException {
		...
		train = loader.load("kenny/ml/svm/polynomial_train.svm");
		test = loader.load("kenny/ml/svm/polynomial_test.svm");
		
		
		k = new Polynomial();
		kp = new KernelParams(k, 0.05, 0.12, 2);
